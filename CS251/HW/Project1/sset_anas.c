...
p->next = NULL;                   // SEGMENTATION FAULT!
...
p = malloc(sizeof(SSET)*10);  

//p = sset_create();

p = from_sorted_array(a, 10);

sset_display(p);

//int *b ;// = sset_toarray(p);
//printf("%d \n", b[1]);
